...
default_args = {
  ...
  'mqtt_broker' : '8eb242a0e0cb48eeb01f9b06f85c79b4.s1.eu.hivemq.cloud', # <<<****** Enter MQTT broker i.e. test.mosquitto.org
...
@dag(dag_id="tml_mqtt_step_3_kafka_producetotopic_dag_ankurpokhrelgpt-71b9", default_args=default_args, tags=["tml_mqtt_step_3_kafka_producetotopic_dag_ankurpokhrelgpt-71b9"], schedule=None,catchup=False)
